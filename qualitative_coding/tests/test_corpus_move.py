...
class TestCorpusMove(QCTestCase):
    def Xtest_move_works_with_files(self):
        self.run_in_testpath("qc corpus import macbeth.txt --importer verbatim")
        self.run_in_testpath("qc corpus move macbeth.txt m.txt")
    ...
    def Xtest_move_works_with_files_in_subdirs(self):
        self.run_in_testpath("qc corpus import macbeth.txt --importer verbatim")
        self.run_in_testpath("qc corpus move macbeth.txt will/macbeth.txt")
